...
class IntegrationConnectionFailedNotice implements NoticeInterface
{
    ...
    public function __construct(callable $isIntegrationPageCallback, callable $authCheckCallback, bool $isSavingSettings, string $apiCreationLink)
    {
    ...
    public function render(): string
    {
        ...
        <div class="notice notice-error zettle" style="padding: 1.2rem 1rem">
            <h4 style="margin-top: 0">
                <?php 
        esc_html_e('PayPal Point of Sale - Unable to connect to PayPal Point of Sale', 'paypal-point-of-sale');
        ?>
            </h4>

            <p>
                <?php 
        esc_html_e('Create a new API key at PayPal Point of Sale and paste it in the field below to connect again.', 'paypal-point-of-sale');
        ?>
            </p>

            <p style="padding-bottom: 1rem;">
                <?php 
        esc_html_e('If the connection problem still occur, please disconnect this integration and reconnect again.', 'paypal-point-of-sale');
        ?>
            </p>

            <a class="button button-secondary" href="<?php 
        echo esc_url($this->apiCreationLink);
        ?>">
                <?php 
        esc_html_e('Create PayPal Point of Sale API key', 'paypal-point-of-sale');
        ?>
            </a>
        </div>
