    ...
    public function render(): string
    {
        ...
        ?>
            ...
            <p style="padding-bottom: .5rem;">
                <?php 
        esc_html_e('Please visit the PayPal Point of Sale integration page to update the API key and connect again.', 'paypal-point-of-sale');
        ?>
            </p>
        ...
        ?>">
                <?php 
        esc_html_e('Go to Integration page', 'paypal-point-of-sale');
        ?>
            </a>
        </div>
