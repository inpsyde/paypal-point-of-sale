...
return ['inpsyde.assets.registry' => static function (C $container, array $previous): array {
    ...
    if ($currentView === 'edit' && $postType === 'product') {
        ...
        $previous[] = new Style('zettle-product-debug-style', "{$assetUri}/product-debug.css", Asset::BACKEND);
        $previous[] = (new Script('zettle-product-debug-modules', "{$assetUri}/product-debug-modules.js", Asset::BACKEND))->withLocalize('zettleProductValidation', static function () use ($container): array {
