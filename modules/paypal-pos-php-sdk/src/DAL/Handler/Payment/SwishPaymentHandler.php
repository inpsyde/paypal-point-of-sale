...
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\DAL\Builder\Payment\SwishPaymentBuilder;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\DAL\Builder\Payment\SwishPaymentBuilderInterface;
...
class SwishPaymentHandler extends AbstractPaymentHandler
{
     ...
     */
    public function __construct(string $validPaymentType, SwishPaymentBuilderInterface $swishPaymentBuilder)
    {
