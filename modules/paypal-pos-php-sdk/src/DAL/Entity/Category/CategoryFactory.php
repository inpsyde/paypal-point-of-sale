...
namespace Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\DAL\Entity\Category;
...
class CategoryFactory
{
     ...
     * @throws Exception
     */
    public function createFromUuid(string $name, string $uuid, ?string $etag = null, ?string $createdAt = null, ?string $updatedAt = null, ?string $updatedBy = null): Category
    {
        return new Category($name, $uuid, $etag, new DateTime($createdAt), new DateTime($updatedAt), $updatedBy);
    }
}
