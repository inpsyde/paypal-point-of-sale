...
class CategoryCollectionFactory
{
     ...
     * @throws Exception
     */
    public function createFromWcProductVariable(WC_Product_Variable $wcProductVariable): CategoryCollection
    {
        ...
        foreach ($terms as $term) {
            $categoryCollection->add($this->categoryFactory->create($term->name));
        }
        return $categoryCollection;
    }
}
