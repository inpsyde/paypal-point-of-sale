...
class LocationFactory
{
     ...
     * @return Location
     */
    public function create(string $uuid, string $type, string $name, ?string $description = null, ?bool $default = null): Location
    {
        // TODO: Create LocationTypeValidator
        return new Location($uuid, LocationType::get($type), $name, $description, $default);
    }
}
