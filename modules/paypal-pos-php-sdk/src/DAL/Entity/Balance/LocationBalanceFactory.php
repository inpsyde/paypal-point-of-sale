...
class LocationBalanceFactory
{
     ...
     */
    public function create(string $locationUuid, string $locationType, string $productUuid, string $variantUuid, string $balance): LocationBalance
    {
        return new LocationBalance($locationUuid, LocationType::get($locationType), $productUuid, $variantUuid, (int) $balance);
    }
}
