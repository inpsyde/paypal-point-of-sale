...
class Variant implements VariantTransferInterface, StockQuantityAwareInterface, PriceAwareInterface
{
     ...
     */
    public function __construct(string $uuid, string $name, string $description, string $sku, int $defaultQuantity, ?Price $price = null, ?Vat $vat = null, ?Presentation $presentation = null, ?VariantOptionCollection $options = null, ?string $unitName = null, ?Price $costPrice = null, ?string $barcode = null)
    {
        $this->uuid = $uuid;
        $this->name = $name;
