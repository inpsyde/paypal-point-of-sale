...
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\DAL\Validator\Payment\PaymentValidator;
...
class PaymentFactory
{
     ...
     */
    public function createCardOnlinePayment(string $uuid, float $amount, string $paymentType): CardOnlinePayment
    {
        try {
     ...
     * @throws EntityFactoryException
     */
    public function createCardPayment(string $uuid, float $amount, string $paymentType, string $referenceNumber, string $maskedPan, string $cardType, string $cardPaymentEntryMode, ?string $applicationName = null, ?string $applicationIdentifier = null, ?string $terminalVerificationResults = null, ?int $numberOfInstallments = null): CardPayment
    {
        try {
     ...
     * @throws EntityFactoryException
     */
    public function createCashPayment(string $uuid, string $paymentType, string $amount, string $handedAmount): CashPayment
    {
        try {
     ...
     * @throws EntityFactoryException
     */
    public function createCustomPayment(string $uuid, string $paymentType, float $amount): CustomPayment
    {
        try {
     ...
     * @throws Exception
     */
    public function createInvoicePayment(string $uuid, string $paymentType, float $amount, string $orderUuid, string $invoiceNumber, string $dueDate): InvoicePayment
    {
        try {
     ...
     * @throws EntityFactoryException
     */
    public function createKlarnaPayment(string $uuid, string $paymentType, float $amount): KlarnaPayment
    {
        try {
     ...
     * @throws EntityFactoryException
     */
    public function createMobilePayment(string $uuid, string $paymentType, float $amount): MobilePayment
    {
        try {
     ...
     * @throws EntityFactoryException
     */
    public function createPaypalPayment(string $uuid, string $paymentType, float $amount): PaypalPayment
    {
        try {
     ...
     * @throws EntityFactoryException
     */
    public function createStoreCreditPayment(string $uuid, string $paymentType, float $amount): StoreCreditPayment
    {
        try {
     ...
     * @throws EntityFactoryException
     */
    public function createSwishPayment(string $uuid, string $paymentType, float $amount): SwishPayment
    {
        try {
     ...
     * @throws EntityFactoryException
     */
    public function createVippsPayment(string $uuid, string $paymentType, float $amount): VippsPayment
    {
        try {
