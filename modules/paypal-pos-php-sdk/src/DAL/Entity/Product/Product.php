...
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\DAL\Entity\PropertyChangeAwareInterface;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\DAL\Entity\PropertyChangeAwareTrait;
...
class Product implements ProductTransferInterface, PropertyChangeAwareInterface
{
     ...
     */
    public function __construct(string $uuid, string $name, string $description, ImageCollection $images, VariantCollection $variants, ?Presentation $presentation = null, ?string $externalReference = null, ?string $etag = null, ?DateTime $updatedAt = null, ?string $updatedBy = null, ?DateTime $createdAt = null, ?Vat $vat = null, ?bool $taxExempt = null, ?bool $usesDefaultTax = null, ?string $unitName = null, ?Metadata $metadata = null)
    {
        $this->uuid = $uuid;
        $this->name = $name;
