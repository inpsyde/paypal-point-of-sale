...
final class CoordinatesBuilder implements CoordinatesBuilderInterface
{
    ...
    {
        return ['latitude' => $coordinates->latitude(), 'longitude' => $coordinates->longitude(), 'accuracyMeters' => $coordinates->accuracyMeters()];
    }
    /**
     * @param array $data
     *
    ...
    {
        return $this->coordinatesFactory->create($data['latitude'], $data['longitude'], $data['accuracyMeters']);
    }
}
