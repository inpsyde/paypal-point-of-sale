...
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\DAL\Entity\Balance\LocationBalanceCollectionFactory;
class LocationBalanceCollectionBuilder implements LocationBalanceCollectionBuilderInterface
{
     ...
     */
    public function __construct(LocationBalanceCollectionFactory $locationBalanceCollectionFactory, LocationBalanceBuilderInterface $locationBalanceBuilder)
    {
    ...
    public function buildFromArray(array $data): LocationBalanceCollection
    {
        ...
        foreach ($data as $locationBalance) {
            $locationBalanceCollection->add($this->locationBalanceBuilder->buildFromArray($locationBalance));
        }
