...
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\DAL\Entity\Purchase\PurchaseHistoryFactory;
class PurchaseHistoryBuilder implements PurchaseHistoryBuilderInterface
{
     ...
     */
    public function __construct(PurchaseHistoryFactory $purchaseHistoryFactory, PurchaseCollectionBuilderInterface $purchaseCollectionBuilder)
    {
    ...
    {
        return ['firstPurchaseHash' => $purchase->firstPurchaseHash(), 'lastPurchaseHash' => $purchase->lastPurchaseHash(), 'purchases' => $this->purchaseCollectionBuilder->createDataArray($purchase->purchases())];
    }
    /**
     * @inheritDoc
     */
    ...
    {
        return $this->purchaseHistoryFactory->create($data['firstPurchaseHash'], $data['lastPurchaseHash'], $this->purchaseCollectionBuilder->buildFromArray($data['purchases']));
    }
}
