...
namespace Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\DAL\Builder\User;
...
class UserBuilder implements UserBuilderInterface
{
    ...
    {
        return ['userId' => $user->id(), 'userDisplayName' => $user->displayName()];
    }
    /**
     * @param array $data
     *
    ...
    {
        return $this->userFactory->create($data['userId'], $data['userDisplayName']);
    }
}
