...
namespace Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\Map\RecordEntity;
...
class Variant
{
     ...
     * @param array $meta
     */
    public function __construct(int $id, string $uuid, int $localId, int $siteId, string $type = self::TYPE, array $meta = [])
    {
        $this->id = $id;
        $this->uuid = $uuid;
