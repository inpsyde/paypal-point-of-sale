...
class OnSuccessDeleteProductsListener implements ApiRestListener
{
     ...
     */
    public function __construct(ProductRepositoryInterface $repository, JobRepository $jobRepository, callable $createJob, LoggerInterface $logger)
    {
    ...
    public function execute($payload): bool
    {
        ...
        $this->jobRepository->add(...[($this->createJob)(UnlinkProductJob::TYPE, ['localId' => $productId]), ($this->createJob)(UnlinkImages::TYPE, ['productId' => $productId])]);
        return \true;
    }
}
