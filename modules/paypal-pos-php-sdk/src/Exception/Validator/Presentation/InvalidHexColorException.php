...
namespace Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\Exception\Validator\Presentation;
...
class InvalidHexColorException extends Exception implements ValidatorException
{
    ...
    {
        parent::__construct("Presentation contains invalid hex color {$color}", 0, $previous);
    }
