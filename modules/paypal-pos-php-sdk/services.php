...
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\API\Listener\Products\OnSuccessDeleteProductsListener;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\API\OAuth\Organizations;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\API\OAuth\Users;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\API\Products\Products;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\API\Taxes\Taxes;
...
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\API\Webhooks\Entity\ZettlePayloadFactory;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\API\Webhooks\Entity\ZettleWebhookFactory;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\API\Webhooks\Subscriptions;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\Builder\ArrayBuilder;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\Builder\BuilderInterface;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\Builder\ContainerAwareBuilder;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\Builder\FilterableBuilder;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\Builder\TypeDelegatingBuilder;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\Builder\ValidatableBuilder;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\Builder\WooCommerceBuilder;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\Config\WooCommerceConfigContainer;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\DAL\Builder\Repository\Variant\VariantBuilderRepository;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\DAL\Builder\Repository\Variant\VariantBuilderRepositoryInterface;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\DAL\Connection\ConnectionType;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\DAL\Provider\Image\PlaceholderUrlProvider;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\DAL\Provider\Image\UrlProviderInterface;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\DAL\Provider\Image\WordPressFilePathProvider;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\DAL\Provider\Image\WordpressUrlProvider;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\DAL\Provider\Organization\OrganizationProvider;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\DAL\Provider\Organization\RestOrganizationProvider;
...
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\Factory\WcProductFactory;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\Factory\WcProductFactoryInterface;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\Filter\CompoundFilter;
...
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\Image\ExtensionImageFormatRetriever;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\Image\ImageFormatRetrieverInterface;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\Map\WpdbMap;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\Provider\BootstrapProvider;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\Repository\WooCommerce\Product\ProductRepository as WcProductRepository;
...
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\Repository\Zettle\Product\ProductRepository;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\Repository\Zettle\Product\ProductRepositoryInterface;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\Serializer\ContainerAwareEntitySerializer;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\Serializer\SerializerInterface;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\Validator\CompoundValidator;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\Validator\LocalImageValidator;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\Validator\PresentationValidator;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\Validator\ProductValidator;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\Validator\ProductVariantOptionDefinitionsValidator;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\Validator\StockValidator;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\Validator\ValidatorInterface;
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\PhpSdk\Validator\VariableProductVatValidator;
...
return array_merge([
    ...
    'paypal-pos.sdk.serializer' => static function (C $container): SerializerInterface {
        return new ContainerAwareEntitySerializer(new NamespacedContainer('paypal-pos.sdk.serializer', $container));
    },
    'paypal-pos.sdk.builder' => static function (C $container): BuilderInterface {
        $arrayBuilderContainer = new NamespacedContainer('paypal-pos.sdk.builder.array', $container);
        $wooBuilderContainer = new NamespacedContainer('paypal-pos.sdk.builder.woocommerce', $container);
        $typedDelegatingBuilder = new TypeDelegatingBuilder(new ArrayBuilder(new ContainerAwareBuilder($arrayBuilderContainer)), new WooCommerceBuilder(new ContainerAwareBuilder($wooBuilderContainer)));
        $filteredBuilder = new FilterableBuilder($typedDelegatingBuilder, $container->get('paypal-pos.sdk.filter'));
        return new ValidatableBuilder($filteredBuilder, $container->get('paypal-pos.sdk.validator'));
    },
    'paypal-pos.sdk.builder.repository.variant' => static function (C $container): VariantBuilderRepositoryInterface {
        return new VariantBuilderRepository($container->get('paypal-pos.sdk.builder'));
    },
    'paypal-pos.sdk.filters.product-connection' => static function (C $container): FilterInterface {
        return new ProductConnectionFilter($container->get('paypal-pos.sdk.id-map.product'), static function () use ($container): Products {
            return $container->get('paypal-pos.sdk.api.products');
        });
    },
    'paypal-pos.sdk.filters.variant-connection' => static function (C $container): FilterInterface {
        return new VariantConnectionFilter($container->get('paypal-pos.sdk.id-map.variant'));
    },
    ...
    'paypal-pos.sdk.filters.tax' => static function (C $container): FilterInterface {
        return new TaxFilter(static function () use ($container): string {
            return $container->get('paypal-pos.sync.taxation-type');
        });
    },
    'paypal-pos.sdk.filters' => static function (C $container): array {
        return [$container->get('paypal-pos.sdk.filters.product-connection'), $container->get('paypal-pos.sdk.filters.variant-connection'), $container->get('paypal-pos.sdk.filters.image-connection'), $container->get('paypal-pos.sdk.filters.tax')];
    },
    'paypal-pos.sdk.filter' => static function (C $container): FilterInterface {
        return new CompoundFilter(...$container->get('paypal-pos.sdk.filters'));
    },
    ...
    'paypal-pos.sdk.validator.variant-option-definitions' => static function (C $container): ValidatorInterface {
        return new VariantOptionDefinitionsValidator();
    },
    'paypal-pos.sdk.validator.product-with-variants' => static function (C $container): ValidatorInterface {
    ...
    'paypal-pos.sdk.validator.local-image' => static function (C $container): ValidatorInterface {
        return new LocalImageValidator($container->get('paypal-pos.sdk.dal.provider.image.file'), $container->get('paypal-pos.sdk.validator.image.exif-supported-types'), $container->get('paypal-pos.sdk.validator.image.min-file-size'), $container->get('paypal-pos.sdk.validator.image.max-file-size'), $container->get('paypal-pos.sdk.validator.image.min-width'), $container->get('paypal-pos.sdk.validator.image.min-height'), $container->get('paypal-pos.sdk.validator.image.max-width'), $container->get('paypal-pos.sdk.validator.image.max-height'));
    },
    'paypal-pos.sdk.validator.wp-image' => static function (C $container): ValidatorInterface {
        return new WordPressImageValidator($container->get('paypal-pos.sdk.validator.image.supported-types'), $container->get('paypal-pos.sdk.validator.image.min-file-size'), $container->get('paypal-pos.sdk.validator.image.max-file-size'), $container->get('paypal-pos.sdk.validator.image.min-width'), $container->get('paypal-pos.sdk.validator.image.min-height'), $container->get('paypal-pos.sdk.validator.image.max-width'), $container->get('paypal-pos.sdk.validator.image.max-height'));
    },
    ...
    'paypal-pos.sdk.validator.image.supported-types' => static function (C $container): array {
        return ['gif', 'jpeg', 'png', 'bmp', 'tiff'];
    },
    'paypal-pos.sdk.validator.image.exif-supported-types' => static function (C $container): array {
        return [\IMAGETYPE_GIF => 'GIF', \IMAGETYPE_JPEG => 'JPEG', \IMAGETYPE_PNG => 'PNG', \IMAGETYPE_BMP => 'BMP', \IMAGETYPE_TIFF_II => 'TIFF', \IMAGETYPE_TIFF_MM => 'TIFF'];
    },
    ...
    'paypal-pos.sdk.validator.stock' => static function (C $container): ValidatorInterface {
        return new StockValidator($container->get('paypal-pos.sdk.validator.stock.max'));
    },
    'paypal-pos.sdk.validator.stock.max' => static function (C $container): int {
        return 99999;
    },
    'paypal-pos.sdk.validator.variant-option' => static function (C $container): ValidatorInterface {
        return new VariantOptionValidator();
    },
    'paypal-pos.sdk.validators' => static function (C $container): array {
        return [$container->get('paypal-pos.sdk.validator.product'), $container->get('paypal-pos.sdk.validator.variable-product-vat'), $container->get('paypal-pos.sdk.validator.presentation'), $container->get('paypal-pos.sdk.validator.variant-option-definitions'), $container->get('paypal-pos.sdk.validator.product-with-variants'), $container->get('paypal-pos.sdk.validator.image'), $container->get('paypal-pos.sdk.validator.variant-option'), $container->get('paypal-pos.sdk.validator.stock')];
    },
    'paypal-pos.sdk.validator' => static function (C $container): ValidatorInterface {
        return new CompoundValidator(...$container->get('paypal-pos.sdk.validators'));
    },
    ...
    'paypal-pos.sdk.id-map.product' => static function (C $container): WpdbMap {
        return new WpdbMap($container->get('paypal-pos.sdk.wpdb'), $container->get('paypal-pos.sdk.dal.table'), ConnectionType::PRODUCT, $container->get('paypal-pos.current-site-id'));
    },
    'paypal-pos.sdk.id-map.variant' => static function (C $container): WpdbMap {
        return new WpdbMap($container->get('paypal-pos.sdk.wpdb'), $container->get('paypal-pos.sdk.dal.table'), ConnectionType::VARIANT, $container->get('paypal-pos.current-site-id'));
    },
    'paypal-pos.sdk.id-map.image' => static function (C $container): WpdbMap {
        return new WpdbMap($container->get('paypal-pos.sdk.wpdb'), $container->get('paypal-pos.sdk.dal.table'), ConnectionType::IMAGE, $container->get('paypal-pos.current-site-id'));
    },
    ...
    'paypal-pos.sdk.provider.bootstrap' => static function (C $container): Provider {
        return new BootstrapProvider($container->get('paypal-pos.sdk.bootstrap'));
    },
    'paypal-pos.sdk.provider' => static function (C $container): array {
        return [$container->get('paypal-pos.sdk.provider.bootstrap')];
    },
    'paypal-pos.sdk.config.woocommerce-config' => static function (C $container): ContainerInterface {
    ...
    'paypal-pos.sdk.dal.provider.image.url' => static function (C $container): UrlProviderInterface {
    ...
    'paypal-pos.sdk.dal.provider.image.file' => static function (C $container): UrlProviderInterface {
    ...
    'paypal-pos.sdk.dal.provider.organization' => static function (C $container): OrganizationProvider {
        return new TransientCachingOrganizationProvider(new RestOrganizationProvider($container->get('paypal-pos.sdk.api.oauth.organizations')), $container->get('paypal-pos.sdk.dal.provider.organization.transient-key'), $container->get('paypal-pos.sdk.dal.provider.organization.transient-expiration'));
    },
    'paypal-pos.sdk.dal.provider.organization.transient-expiration' => static function (): int {
        return 5 * 60;
        // 5 minutes
    },
    ...
    'paypal-pos.sdk.api.listener.delete.product' => static function (C $container): OnSuccessDeleteProductsListener {
    ...
    'paypal-pos.sdk.repository.woocommerce.product' => static function (C $container): WcProductRepositoryInterface {
        return new WcProductRepository();
    },
    'paypal-pos.sdk.repository.zettle.product' => static function (C $container): ProductRepositoryInterface {
        return new ProductRepository($container->get('paypal-pos.sdk.id-map.product'));
    },
    'paypal-pos.sdk.factory.woocommerce.product' => static function (C $container): WcProductFactoryInterface {
        return new WcProductFactory($container->get('paypal-pos.sdk.repository.zettle.product'), $container->get('paypal-pos.sdk.repository.woocommerce.product'));
    },
    'paypal-pos.sdk.image.format-retrievers.exif' => static function (C $container): ImageFormatRetrieverInterface {
        return new ExifImageFormatRetriever();
    },
    'paypal-pos.sdk.image.format-retrievers.extension' => static function (C $container): ImageFormatRetrieverInterface {
        return new ExtensionImageFormatRetriever();
    },
    'paypal-pos.sdk.image.format-retriever' => static function (C $container): ImageFormatRetrieverInterface {
        return $container->get('paypal-pos.sdk.image.format-retrievers.extension');
    },
], require __DIR__ . '/builders.array.php', require __DIR__ . '/builders.woocommerce.php', require __DIR__ . '/serializers.php');
