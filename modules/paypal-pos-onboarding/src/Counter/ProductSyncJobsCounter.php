...
namespace Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\Onboarding\Counter;
...
class ProductSyncJobsCounter
{
     ...
     */
    public function __construct(callable $productCollectorLocal, string $syncCollisionStrategy)
    {
