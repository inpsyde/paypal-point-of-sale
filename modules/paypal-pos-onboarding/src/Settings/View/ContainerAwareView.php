    ...
    private function view(): OnboardingView
    {
        ...
        switch ($stateMachine->currentState()->name()) {
            ...
            case OnboardingState::INVALID_CREDENTIALS:
                $this->view = (new SimpleView(__('Authentication failed', 'paypal-point-of-sale'), __("We could not authenticate with the credentials you provided.\n                        Press 'Start over' to re-enter your credentials.\n                        ", 'paypal-point-of-sale')))->withProceedButton(__('Start over', 'paypal-point-of-sale'));
                break;
            ...
            case OnboardingState::SYNC_FINISHED:
                $this->view = new SyncFinishedView($this->container->get('paypal-pos.onboarding.zettle-products-link'));
                break;
            ...
            case OnboardingState::UNHANDLED_ERROR:
                ...
                break;
            default:
                $this->view = (new SimpleView(sprintf('%s__WHOOPS__', $stateMachine->currentState()->name()), ''))->withBackButton();
        }
        return $this->view;
    }
}
