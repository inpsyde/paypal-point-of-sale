...
use Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\Onboarding\Settings\ButtonKind;
class UnhandledErrorView implements OnboardingView
{
    ...
    public function renderHeader(): string
    {
        ...
        <h2>
            <?php 
        esc_html_e('Critical error', 'paypal-point-of-sale');
        ?>
        </h2>
    ...
    public function renderContent(): string
    {
        ...
        <p>
            <?php 
        esc_html_e("A critical error occurred.\n                Please check the WooCommerce logs for more details\n                and press 'Start over' to restart installation.", 'paypal-point-of-sale');
        ?>
        </p>
