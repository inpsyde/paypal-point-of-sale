...
class ResetOnboardingJob implements Job
{
    ...
    public function __construct(wpdb $database, ClearableContainerInterface $optionContainer, ClearableContainerInterface $setupInfoContainer, TokenPersistorInterface $tokenStorage, array $tables, array $transients, array $options, callable $deleteWebhooks)
    {
    ...
    {
        try {
            $this->resetOnboarding($logger, $this->database->get_blog_prefix());
            return \true;
