...
namespace Syde\Vendor\Zettle\Syde\PayPal\PointOfSale\Onboarding\Cli;
...
class ResetOnboardingCommand
{
     ...
     */
    public function __construct(Job $resetOnboardingJob, bool $isMultisite, int $currentSiteId, LoggerInterface $logger)
    {
    ...
    public function site(array $args, array $assocArgs): void
    {
        ...
        $this->resetOnboardingJob->execute(Context::fromArray([], $this->currentSiteId), new EphemeralJobRepository(), $this->logger);
    }
}
