...
return ['paypal-pos.settings.fields.registry' => static function (array $previous, ContainerInterface $container): array {
...
}, 'paypal-pos.sdk.filters' => static function (array $previous, ContainerInterface $container): array {
    ...
    return $previous;
}, 'inpsyde.wc-lifecycle-events.products.listener-provider' => static function (ProductEventListenerRegistry $registry, ContainerInterface $container): ProductEventListenerRegistry {
