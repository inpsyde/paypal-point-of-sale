    ...
    public function run(ContainerInterface $container): bool
    {
        if (defined('Syde\Vendor\Zettle\WP_CLI') && WP_CLI) {
            try {
                ...
                WP_CLI::add_command("zettle reset", $container->get('paypal-pos.sync.cli.reset'));
                WP_CLI::add_command("zettle export", $container->get('paypal-pos.sync.cli.export'));
                WP_CLI::add_command('zettle exclude', $container->get('paypal-pos.sync.cli.exclude'));
        ...
        if (is_admin() && $container->get('paypal-pos.sync.price-sync-enabled') && !$container->get('paypal-pos.auth.is-failed')) {
            try {
