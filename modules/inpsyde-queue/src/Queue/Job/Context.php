...
class Context implements ContextInterface
{
    ...
    public static function fromArray(array $data, ?int $siteId = null, int $retryCount = 0, ?DateTime $created = null, int $id = 0): ContextInterface
    {
        return new self((object) $data, $created ?? new DateTime(), $siteId ?? get_current_blog_id(), $retryCount, $id);
    }
