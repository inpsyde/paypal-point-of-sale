...
use Syde\Vendor\Zettle\Inpsyde\WcEvents\ParameterDeriver;
...
class ProductEventListenerRegistry
{
    ...
    {
        foreach ($callables as $callable) {
            $this->listeners[] = $this->createPropertyGuard($property, $this->createTypeMatchingGuard($callable));
        }
    }
    /**
    ...
    {
        foreach ($callables as $callable) {
            $this->listeners[] = $this->createCatalogVisibilityGuard($visibility, $this->createTypeMatchingGuard($callable));
        }
    }
    /**
