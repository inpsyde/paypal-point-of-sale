...
class SettingsPage extends WC_Settings_Page
{
     ...
     */
    public function __construct(WC_Settings_API $settingsApi, string $id, string $label, LoggerInterface $logger, bool $isDebugMode)
    {
    ...
    public function output()
    {
        ...
        try {
            ...
            <h3 style="color: red;">
                <?php 
            esc_html_e('A critical error occurred. Please check the WooCommerce logs for more details.', 'paypal-point-of-sale');
            ?>
            </h3>
            <?php 
            echo ob_get_clean();
