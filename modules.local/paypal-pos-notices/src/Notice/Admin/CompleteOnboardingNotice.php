...
class CompleteOnboardingNotice implements NoticeInterface
{
    ...
    public function __construct(
        callable $isPluginsPageCallback,
        string $settingsUrl
    ) {
    ...
    public function render(): string
    {
        ...
        <div class="notice zettle" style="padding: 1.2rem 1rem">
            <h4>
                <?php esc_html_e(
                    'PayPal Point of Sale Configuration',
            ...
            <p>
                <?php esc_html_e(
                    'It looks like this is the first time you are using PayPal Point of Sale for WooCommerce.',
                    'paypal-point-of-sale'
                ); ?>
            </p>
            ...
            <a class="button button-secondary" href="<?php echo esc_url($this->settingsUrl) ?>">
                <?php esc_html_e('Take me there!', 'paypal-point-of-sale') ?>
            </a>
        </div>
