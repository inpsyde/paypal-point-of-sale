    ...
    'paypal-pos.settings.fields.registry' =>
        static function (array $previous, ContainerInterface $container): array {
            return array_merge(
                ...
                [
                    'authentication' => [
                        'title' => __('Authentication', 'paypal-point-of-sale'),
                        'type' => 'title',
                        'description' => __(
                            'Credentials needed for communicating with your PayPal Point of Sale store via its API',
                            'paypal-point-of-sale'
                        ),
                    ],
                    'api_key' => [
                        'title' => __('API key', 'paypal-point-of-sale'),
                        'type' => 'zettle-writeonly-password',
                        'description' => __(
                            'Enter the API key you created through PayPal Point of Sale.',
                            'paypal-point-of-sale'
                        ),
                        'desc_tip' => true,
                        'default' => '',
