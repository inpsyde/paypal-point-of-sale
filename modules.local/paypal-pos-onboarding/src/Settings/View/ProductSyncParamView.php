    ...
    public function renderHeader(): string
    {
        ...
        <p>
            ...
            if ($this->zettleProductsCount() > 0) {
                echo esc_html(__(
                    'How would you like to set up your PayPal Point of Sale library?',
            ...
            <div class="form-choice-selector">
                ...
                <div class="form-choice-selector-content">
                    ...
                    <p class="form-choice-selector-content-description">
                        <?php esc_html_e(
                            'Synced WooCommerce products and stock quantities will be added to the existing PayPal Point of Sale library.',
                            'zettle-woocommerce'
                        ); ?>
                    </p>
                </div>
            ...
            <div class="form-choice-selector">
                ...
                <div class="form-choice-selector-content">
                    <label for="zettle-wipe-products">
                        <?php esc_html_e('Replace PayPal Point of Sale library', 'zettle-woocommerce'); ?>
                    </label>

                    <p class="form-choice-selector-content-description">
                        <?php esc_html_e(
                            'Replace your existing PayPal Point of Sale library with synced products and stock quantities from WooCommerce.',
                            'zettle-woocommerce'
                        ); ?>
                    </p>
                </div>
        ...
        if ($this->supportedWcProductsCount() !== $this->totalWcProductsCount()) {
            return sprintf(
                ...
                sprintf(
                    ...
                    esc_html__('here', 'paypal-point-of-sale')
                )
            );
        }
