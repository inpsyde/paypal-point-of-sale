...
class SyncFinishedView implements OnboardingView
{
    ...
    public function renderContent(): string
    {
        ...
        <p>
            <?php esc_html_e(
                'In the future, when you make a sale or edit stock, we will update your stock in PayPal Point of Sale and WooCommerce.',
        ...
        <p>
            <?php esc_html_e(
                'If you need to update your products, do this in WooCommerce and they\'ll sync to your PayPal Point of Sale app automatically.',
                'paypal-point-of-sale'
            ) ?>
        </p>
    ...
    {
        return $this->renderActionButton(ButtonAction::PROCEED, __('Complete setup', 'paypal-point-of-sale'));
    }
