...
class WelcomeView implements OnboardingView
{
    ...
    public function renderHeader(): string
    {
        ...
        <h2>
            <?php esc_html_e(
                'Grow your business with PayPal Point of Sale and WooCommerce',
    ...
    public function renderContent(): string
    {
        ...
        <p>
            <?php esc_html_e(
                'The PayPal Point of Sale point-of-sale system allows you to take cash, card, contactless payments and more.
                 Connect WooCommerce with PayPal Point of Sale to keep products and inventory in sync – all in one place.',
                'paypal-point-of-sale'
            ) ?>
        </p>
        ...
        <p>
            <?php esc_html_e(
                'Sync your WooCommerce products and inventory to PayPal Point of Sale in a few clicks.
        ...
        <p>
            <?php esc_html_e(
                'To see which markets PayPal Point of Sale is available in, please visit ',
                'paypal-point-of-sale'
            ); ?>
        ...
        <div class="zettle-settings-onboarding-content-get-started">
            <h3><?php esc_html_e('How to get started', 'paypal-point-of-sale') ?></h3>
    ...
    public function renderGetStartedContent(): string
    {
        ...
        <div class="zettle-settings-onboarding-content-get-started-container columns-3">
            <div class="column">
                ...
                <p>
                    <?php esc_html_e(
                        'Connect your accounts, sync your library to PayPal Point of Sale and start selling.',
                        'paypal-point-of-sale'
                    ); ?>
                </p>
            </div>
            <div class="column">
                ...
                <p>
                    <?php esc_html_e(
                        'Products sync from WooCommerce to PayPal Point of Sale automatically.',
                        'paypal-point-of-sale'
                    ); ?>
                </p>
            </div>
