...
class ProductSettingsTab
{
    ...
    public function renderSettings(bool $addBarcodeInput): void
    {
        ...
        <div id="zettle_integration_panel" class="panel woocommerce_options_panel">
            <h2>
                <?php esc_html_e('Product Library Sync', 'paypal-point-of-sale'); ?>
            </h2>
            ...
            <div class="options_group">
                ...
                woocommerce_wp_checkbox(
                    [
                        ...
                        'label' => esc_html__('Exclude from Sync?', 'paypal-point-of-sale'),
            ...
            if ($addBarcodeInput) {
                ...
                <div class="show_if_simple">
                    <h2>
                        <?php esc_html_e('Barcode', 'paypal-point-of-sale'); ?>
                    </h2>
