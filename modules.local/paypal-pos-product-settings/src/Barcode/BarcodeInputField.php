    ...
    public function render(WC_Product $product, ?int $index = null): string
    {
        ...
        <div class="zettle-barcode-input">
            ...
            <div class="zettle-barcode-scan" style="display: none">
                <div>
                    <label><?= esc_html__('Barcode type', 'paypal-point-of-sale') ?>
                        <select name="barcode_type">
                            <option value="ean_extended,ean,ean_8,code_128,code_39" selected="selected">
                                <?= esc_html__('EAN (13, 8, extended), Code 128, Code 39', 'paypal-point-of-sale') ?>
                            </option>
                            <option value="code_128">Code 128</option>
                            <option value="code_39">Code 39</option>
                            <option value="code_39_vin">Code 39 VIN</option>
                            <option value="ean">EAN-13</option>
                            <option value="ean_extended"><?= esc_html__('EAN extended', 'paypal-point-of-sale') ?></option>
                            <option value="ean_8">EAN-8</option>
                            <option value="upc">UPC-A</option>
                            <option value="upc_e">UPC-E</option>
                            <option value="codabar">Codabar</option>
                            <option value="i2of5"><?= esc_html__('I2 of 5', 'paypal-point-of-sale') ?></option>
                            <option value="2of5"><?= esc_html__('Standard 2 of 5', 'paypal-point-of-sale') ?></option>
                            <option value="code_93">Code 93</option>
                        </select>
                    </label>
                </div>
                <div>
                    <label><?= esc_html__('Camera', 'paypal-point-of-sale') ?>
                        <select name="camera">
                        </select>
                    </label>
                </div>
