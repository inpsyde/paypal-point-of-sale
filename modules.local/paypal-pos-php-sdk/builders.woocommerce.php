...
use Syde\PayPal\PointOfSale\PhpSdk\Builder\VariantBuilder;
use Syde\PayPal\PointOfSale\PhpSdk\Builder\VariantOptionCollectionBuilder;
use Syde\PayPal\PointOfSale\PhpSdk\Builder\VariantOptionDefinitionsBuilder;
...
use Syde\PayPal\PointOfSale\PhpSdk\DAL\Entity\Metadata\Source;
...
use Syde\PayPal\PointOfSale\PhpSdk\DAL\Entity\Variant\WcVariationIterator;
...
return [
    ...
    $key(VariantInterface::class) => static function (C $container) {
        return new VariantBuilder(
            ...
            $container->get('paypal-pos.sync.taxation-type'),
        ...
        static function (WC_Product $wcProduct, B $builder, C $container) {
            ...
            try {
                ...
                return new LazyImage(
                    $imageId,
                    $urlProvider,
                    $container->get('paypal-pos.sdk.api.images'),
                    $imageIdMap
                );
            }
        }
    ...
    $key(Price::class) => static function (C $container): B {
        return new PriceBuilder(
            $container->get('paypal-pos.sdk.config.woocommerce-config'),
            $container->get('paypal-pos.sync.taxation-mode')
        );
    },
