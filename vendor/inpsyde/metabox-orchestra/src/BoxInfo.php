...
final class BoxInfo implements \ArrayAccess
{
    ...
    {
        $priority = in_array($priority, self::PRIORITIES, \TRUE) ? $priority : self::PRIORITY_ADVANCED;
        $context = in_array($context, self::CONTEXTS, \TRUE) ? $context : self::CONTEXT_ADVANCED;
