...
class Plugin implements PluginInterface, EventSubscriberInterface
{
    ...
    private const INTERFACE_MAP = ['php-http/async-client-implementation' => ['Syde\Vendor\Zettle\Http\Client\HttpAsyncClient'], 'php-http/client-implementation' => ['Syde\Vendor\Zettle\Http\Client\HttpClient'], 'psr/http-client-implementation' => ['Syde\Vendor\Zettle\Psr\Http\Client\ClientInterface'], 'psr/http-factory-implementation' => ['Syde\Vendor\Zettle\Psr\Http\Message\RequestFactoryInterface', 'Syde\Vendor\Zettle\Psr\Http\Message\ResponseFactoryInterface', 'Syde\Vendor\Zettle\Psr\Http\Message\ServerRequestFactoryInterface', 'Syde\Vendor\Zettle\Psr\Http\Message\StreamFactoryInterface', 'Syde\Vendor\Zettle\Psr\Http\Message\UploadedFileFactoryInterface', 'Syde\Vendor\Zettle\Psr\Http\Message\UriFactoryInterface']];
    ...
    public function getMissingRequires(InstalledRepositoryInterface $repo, array $requires, bool $isProject, array $pinnedAbstractions): array
    {
        ...
        if (ClassDiscovery::safeClassExists(\Syde\Vendor\Zettle\Phalcon\Http\Message\RequestFactory::class, \false)) {
