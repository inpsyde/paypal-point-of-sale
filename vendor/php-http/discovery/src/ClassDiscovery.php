...
use Syde\Vendor\Zettle\Http\Discovery\Exception\ClassInstantiationFailedException;
use Syde\Vendor\Zettle\Http\Discovery\Exception\DiscoveryFailedException;
use Syde\Vendor\Zettle\Http\Discovery\Exception\NoCandidateFoundException;
use Syde\Vendor\Zettle\Http\Discovery\Exception\StrategyUnavailableException;
use Syde\Vendor\Zettle\Http\Discovery\Strategy\DiscoveryStrategy;
/**
