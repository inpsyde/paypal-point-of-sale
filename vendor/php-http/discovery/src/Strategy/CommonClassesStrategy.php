...
use Syde\Vendor\Zettle\GuzzleHttp\Client as GuzzleHttp;
use Syde\Vendor\Zettle\GuzzleHttp\Promise\Promise;
use Syde\Vendor\Zettle\GuzzleHttp\Psr7\Request as GuzzleRequest;
use Syde\Vendor\Zettle\Http\Adapter\Artax\Client as Artax;
use Syde\Vendor\Zettle\Http\Adapter\Buzz\Client as Buzz;
use Syde\Vendor\Zettle\Http\Adapter\Cake\Client as Cake;
use Syde\Vendor\Zettle\Http\Adapter\Guzzle5\Client as Guzzle5;
use Syde\Vendor\Zettle\Http\Adapter\Guzzle6\Client as Guzzle6;
use Syde\Vendor\Zettle\Http\Adapter\Guzzle7\Client as Guzzle7;
use Syde\Vendor\Zettle\Http\Adapter\React\Client as React;
use Syde\Vendor\Zettle\Http\Client\Curl\Client as Curl;
use Syde\Vendor\Zettle\Http\Client\HttpAsyncClient;
use Syde\Vendor\Zettle\Http\Client\HttpClient;
use Syde\Vendor\Zettle\Http\Client\Socket\Client as Socket;
...
use Syde\Vendor\Zettle\Http\Message\MessageFactory\DiactorosMessageFactory;
use Syde\Vendor\Zettle\Http\Message\MessageFactory\GuzzleMessageFactory;
use Syde\Vendor\Zettle\Http\Message\MessageFactory\SlimMessageFactory;
use Syde\Vendor\Zettle\Http\Message\StreamFactory;
use Syde\Vendor\Zettle\Http\Message\StreamFactory\DiactorosStreamFactory;
use Syde\Vendor\Zettle\Http\Message\StreamFactory\GuzzleStreamFactory;
use Syde\Vendor\Zettle\Http\Message\StreamFactory\SlimStreamFactory;
use Syde\Vendor\Zettle\Http\Message\UriFactory;
use Syde\Vendor\Zettle\Http\Message\UriFactory\DiactorosUriFactory;
use Syde\Vendor\Zettle\Http\Message\UriFactory\GuzzleUriFactory;
use Syde\Vendor\Zettle\Http\Message\UriFactory\SlimUriFactory;
use Syde\Vendor\Zettle\Laminas\Diactoros\Request as DiactorosRequest;
use Syde\Vendor\Zettle\Nyholm\Psr7\Factory\HttplugFactory as NyholmHttplugFactory;
use Syde\Vendor\Zettle\Psr\Http\Client\ClientInterface as Psr18Client;
use Syde\Vendor\Zettle\Psr\Http\Message\RequestFactoryInterface as Psr17RequestFactory;
use Syde\Vendor\Zettle\Slim\Http\Request as SlimRequest;
use Syde\Vendor\Zettle\Symfony\Component\HttpClient\HttplugClient as SymfonyHttplug;
use Syde\Vendor\Zettle\Symfony\Component\HttpClient\Psr18Client as SymfonyPsr18;
/**
 * @internal
 *
...
final class CommonClassesStrategy implements DiscoveryStrategy
{
    ...
    {
        return new \Syde\Vendor\Zettle\Buzz\Client\FileGetContents(Psr17FactoryDiscovery::findResponseFactory());
    }
    ...
    {
        return defined('Syde\Vendor\Zettle\GuzzleHttp\ClientInterface::MAJOR_VERSION');
    }
