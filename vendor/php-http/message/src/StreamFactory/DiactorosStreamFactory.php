...
namespace Syde\Vendor\Zettle\Http\Message\StreamFactory;

use Syde\Vendor\Zettle\Http\Message\StreamFactory;
use Syde\Vendor\Zettle\Laminas\Diactoros\Stream as LaminasStream;
use Syde\Vendor\Zettle\Psr\Http\Message\StreamInterface;
use Syde\Vendor\Zettle\Zend\Diactoros\Stream as ZendStream;
