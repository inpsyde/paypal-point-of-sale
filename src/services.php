...
return [
    'paypal-pos.is-debug' => static function (C $container): bool {
    ...
    'paypal-pos.requirements.validator' => static function (C $container): ValidatorInterface {
        ...
        return new CompositeValidator([
            $container->get('paypal-pos.requirements.plugins.validator'),
            $container->get('paypal-pos.requirements.extensions.validator'),
        ]);
    },
    ...
    'paypal-pos.requirements.plugins.validator' => static function (C $container): ValidatorInterface {
        return new RequiredPluginsValidator(
            $container->get('paypal-pos.requirements.plugins')
        );
    },
    ...
    'paypal-pos.requirements.extensions.validator' => static function (C $container): ValidatorInterface {
        return new RequiredExtensionsValidator(
            $container->get('paypal-pos.requirements.extensions')
        );
    },
    ...
    'paypal-pos.logger' => static function (C $container): CompoundLogger {
        return new CompoundLogger(
            ...
            $container->get('paypal-pos.logger.wonolog')
        );
    },
